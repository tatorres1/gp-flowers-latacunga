    ...
    return (
        ...
        <div className='w-full min-h-screen  bg-gradient-to-r from-lime-300 to-cyan-300 p-3'>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-5 ">
                ...
                <div>
                    <button type="button" className="flex flex-col items-center p-8 text-calc(4vw + 16px) font-bold bg-white hover:bg-gradient-to-bl hover:ring-8 focus:ring-4 rounded-lg focus:ring-green-200 rounded-lg text-center mr-2 mb-2"
                ...
                {(valorRol == "Administrador") && <div>
                    <button type="button" className="flex flex-col items-center p-8 text-calc(4vw + 16px) font-bold bg-white hover:bg-gradient-to-bl hover:ring-8 focus:ring-4 focus:ring-green-200 rounded-lg text-center mr-2 mb-2"
                        onClick={IrAlmacen}>
                        <svg width="50%" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
